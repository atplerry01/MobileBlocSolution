                                                                ...
                                                                <div class="col-lg-6 mb-3">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        ...
                                                                        <a href="../../demo1/dist/dashboards/ecommerce.html"
                                                                            ...
                                                                            <span class="d-flex flex-column">
                                                                                <span
                                                                                    class="fs-6 fw-bold text-gray-800">Schedule & Availability</span>
                                    ...
                                    <div class="app-navbar-item ms-1 ms-md-3">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
                                            ...
                                            <div class="d-flex flex-column bgi-no-repeat rounded-top"
                                                data-style="background-image:url('assets/media/misc/menu-header-bg.jpg')">
                    ...
                    <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                        ...
                        <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
                            ...
                            <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                                ...
                                <a href="#" style={{ color: '#fff', fontSize: 22}}>
                                    HealthBloc
                                </a>
                                        ...
                                        <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                            ...
                                            <div class="menu-sub menu-sub-accordion">
                                                ...
                                                <div class="menu-item">
                                                    ...
                                                    <a class="menu-link active" href="/patients">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                ...
                                                <div class="menu-item">
                                                    ...
                                                    <a class="menu-link" href="/patients/external">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">External Patients</span>
                                                    </a>
                                                </div>

                                                <div class="menu-item">
                                                    <a class="menu-link" href="/patients/cloud-sync">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Cloud Sync</span>
                                                    </a>
                                                </div>
                                                ...
                                                <div class="menu-item">
                                                    ...
                                                    <a class="menu-link" href="patients/createProvider">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                ...
                                <div
                                    ...
                                    <div class="text-dark order-2 order-md-1">
                                        ...
                                        <a href="#" target="_blank"
                                            class="text-gray-800 text-hover-primary">B00731241</a>
                                    </div>
